## Usage : retval = convert_kicker_value(targetElement, inVal, brho, isOutAngle)
##
## = Parameters
...
function retval = convert_kicker_value(targetElement, inVal, brho, isOutAngle)
