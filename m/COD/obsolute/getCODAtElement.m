## obsolute. use lookup_cod_at_elements
## usage : result = getCODAtElement(cod_rec, cod_field_name, elem_names)
##
...
function result = getCODAtElement(cod_rec, cod_field_name, elem_names)
