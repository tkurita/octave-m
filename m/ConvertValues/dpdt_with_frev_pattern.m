## -*- texinfo -*-
## @deftypefn {Function File} {@var{dpdt} =} dpdt_with_frev_pattern(@var{frev_t}, @var{C}, @var{particle})
##
## evaluate dp/dt 
##
## @strong{Inputs}
...
function dpdt = dpdt_with_frev_pattern(frev_t, C ,particle)
  if ! nargin
    print_usage();
  endif
  ...
  dpdt = (m0c2/lv^2)*C.*((1 - b.^2).^(-3/2)).*dfdt;
  dpdt = [frev_t(:,1), dpdt];
endfunction
