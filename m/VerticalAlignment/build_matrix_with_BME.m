## usage: all_elements = build_matrix_WMAST(qfk,qdk,[vedge] )
##
...
function all_elements = build_matrix_with_BME(varargin)
  if ! nargin
    print_usage();
  endif
  ...
  bmprop = tars(bmangle, efflen, edgeangle, vedge);
  #bmprop = tars(bmangle, radius, edgeangle, vedge);
  bmdl = (efflen - radius * bmangle)/2;

  ##== properties of Q lens
  qefflen = 0.21; # effective length of q [m]
  qlen = 0.15; # length of q magnet [m]
  qlength.len = qefflen; 
  qdl = (qefflen - qlen)/2;
  ...
  DT(0.1750-qdl, "MRD1IN", MRD1),
  QF(qfk, qlength ,"QF1", MRD1),
  DT(0.15-qdl, "MRD1OUT", MRD1),
  ...
  DT(0, "BM1INEDGE", bmDuct1),
  BM(bmprop, "BM1", bmDuct1),
  DT(0, "BM1OUTEDGE", bmDuct1),
  DT(0.175-bmdl, "BMD1OUT", bmDuct1),
  DT(0.1675,"FCT", FCTDuct),
  DT(0.2125,"DFCTOUT", FCTDuct),
  DT(0.1450-qdl,"MRD3IN", MRD3),
  QD(qdk,qlength,"QD1", MRD3),
  DT(0.13-qdl, "MRD3OUT", MRD3),
  DT(0.07, "MRD4IN", MRD4),
  DT(0.2, "BMPi1", MRD4),
  DT(0.125, "MRD4OUT", MRD4),
  DT(0.175-bmdl, "BMD2IN", bmDuct2),
  DT(0, "BM2INEDGE", bmDuct2),
  BM(bmprop, "BM2", bmDuct2),
  DT(0, "BM2OUTEDGE", bmDuct2),
  DT(0.175-bmdl, "BMD2OUT", bmDuct2),
  DT(0.35, "MRD5", MRD5),
  ...
  DT(0.3, "CT", (133e-3)/2),
  DT(0.18-qdl, "MRD6IN", MRD6),
  QF(qfk,qlength,"QF2", MRD6),
  DT(0.245-qdl,"MRD6OUT", MRD6),
  ...
  DT(0, "BM3INEDGE", bmDuct2),
  BM(bmprop, "BM3", bmDuct2),
  DT(0, "BM3OUTEDGE", bmDuct2),
  DT(0.175-bmdl, "BMD3OUT", bmDuct2),
  DT(0.125,"MRD8IN", MRD8),
  DT(0.2,"BMPe1", MRD8),
  DT(0.2-qdl,"MRD8M", MRD8),
  QD(qdk,qlength,"QD2", MRD8),
  DT(0.25-qdl,"MRD8OUT", MRD8),
  DT(0.1375,"DBPM3IN", bpmDuct),
  DT(0,"STH3", bpmDuct),
  DT(0,"BPM3", bpmDuct),
  DT(0.1375,"DBPM3OUT", bpmDuct),
  DT(0.175-bmdl, "BMD4IN", bmDuct2),
  DT(0, "BM4INEDGE", bmDuct2),
  BM(bmprop, "BM4", bmDuct2),
  DT(0, "BM4OUTEDGE", bmDuct2),
  DT(0.175-bmdl, "BMD4OUT", bmDuct2),
  ...
  DT(0.145-qdl, "MRD9IN", MRD9),
  QF(qfk, qlength, "QF3", MRD9),
  DT(0.22-qdl, "MRD9OUT", MRD9),
  ...
  DT(0.175-bmdl, "BMD5IN", bmDuct2),
  DT(0, "BM5INEDGE", bmDuct2),
  BM(bmprop, "BM5", bmDuct2),
  DT(0, "BM5OUTEDGE", bmDuct2),
  DT(0.175-bmdl,"BMD5OUT", bmDuct2),
  DT(0.1975,"DPR2IN", [143.2e-3/2]),
  DT(0, "PR2", [143.2e-3/2]),
  DT(0.2025, "DPR2OUT", [143.2e-3/2]),
  DT(0.125-qdl, "MRD10IN", MRD10),
  QD(qdk,qlength,"QD3", MRD10),
  DT(0.2-qdl,"MRD10M", MRD10),
  DT(0.2,"BMPe2", MRD10),
  DT(0.125,"MRD10OUT", MRD10),
  DT(0.175-bmdl,"BMD6IN", bmDuct2),
  DT(0, "BM6INEDGE", bmDuct2),
  BM(bmprop, "BM6", bmDuct2),
  DT(0, "BM6OUTEDGE", bmDuct2),
  DT(0.175-bmdl, "BMD6OUT", bmDuct2),
  ...
  DT(0.135-qdl, "MRD12IN2", MRD12_2),
  QF(qfk,qlength,"QF4", MRD12_2), 
  DT(0.15-qdl, "MRD12OUT", MRD12_2),
  ...
  DT(0, "BM7INEDGE", bmDuct2),
  BM(bmprop, "BM7", bmDuct2),
  DT(0, "BM7OUTEDGE", bmDuct2),
  DT(0.175-bmdl,"BMD7OUT", bmDuct2),
  DT(0.125,"MRD14IN", MRD14),
  DT(0.2,"BMPi2", MRD14),
  DT(0.07, "MRD14OUT", MRD14),
  DT(0.13-qdl,"MRD15IN", MRD15),
  QD(qdk, qlength,"QD4", MRD15),
  DT(0.3-0.05-qdl,"MRD15OUT", MRD15),
  DT(0.1375,"DBPM6IN", bpmDuct), 
  DT(0,"STH6", bpmDuct),
  DT(0,"BPM6", bpmDuct),
  DT(0.1375,"DBPM6OUT", bpmDuct),
  DT(0.175-bmdl,"BMD8IN", bmDuct1),
  DT(0, "BM8INEDGE", bmDuct1),
  BM(bmprop, "BM8", bmDuct1),
  DT(0, "BM8OUTEDGE", bmDuct1),
  DT(0.175-bmdl,"BMD8OUT", bmDuct1),
