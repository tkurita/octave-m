## -*- texinfo -*-
## 未実装
## @deftypefn {Function File} {@var{retval} =} step_Vp_Vn(@var{config})
##
## Evaluate step response of Vp/Vn
##
## Vp : output of phase detector
## Vn : noise
##
##
## @end deftypefn

function varargout = step_Vp_Vn(varargin)
  pkg load control;
  if !nargin
    print_usage();
    return;
