## usage: all_elements = build_vaccum_duct(qfk,qdk,[vedge] )
##
...
function all_elements = build_vaccum_duct(varargin)
  ...
  DT(0.64, "ESI", [-350+15, 130-15, 138, -300+138]*1e-3 ),
  DT(0.13, "ESIChamberOUT", [165e-3/2]),
  ...
  DT(0.13, "ESDChamberIN", 165e-3/2),
  DT(1.220, "ESD", [350-15, -130+15, 138, -300+138]*1e-3),
  DT(0.13, "ESDChamberOUT", 165e-3/2),
