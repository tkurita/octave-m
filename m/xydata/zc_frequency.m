## -*- texinfo -*-
## @deftypefn {Function File} {@var{retval} =} zc_frequency(@var{xy}, [@var{diff_threshold}, @var{method}, "need_amplitude", "timerange", @var{tr}])
...
function retval = zc_frequency(xy_in, varargin)
  diff_threshold = 5;
  method = "interp";
