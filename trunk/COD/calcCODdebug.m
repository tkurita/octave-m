...
function codList = calcCODDebug(steererNames,steererValues,allElements,brho,tune,horv)
  ...
  [stPhaseList,stBetaList,steererF]
								#[betaList;steererF]

  codList = [];
  for n = 1:length(phaseList) 
	theCOD = 1000 * sum(sqrt(stBetaList) .*steererF \
