...
#      endif
      ...
      # fixed for gnuplot 4.2 by tkurita 2010-06-04
#      if (! isempty (font))
#        options = cstrcat (options, " fname \"", font, "\" "); 
#      endif
#      if (! isempty (fontsize))
#        options = cstrcat (options, " fsize ", fontsize);
#      endif

      # fixed for gnuplot 4.4 by tkurita 2011-12-21
      if (isempty (font))
        font_spec = "";
      else
        font_spec = font;
      ...
      if (! isempty (fontsize))
        font_spec = cstrcat (font_spec, ",", fontsize);
      endif
      if (! isempty (font_spec))
        options = cstrcat (options, " font \"", font_spec,"\"");
      endif
    endif
