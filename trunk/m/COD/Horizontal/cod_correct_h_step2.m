...
##== History
## 2009-07-14
## * add kickFactor into returned structure.
## * steererValues field of returnd structure is updated with following kickFactor.
##
## 2007.09.05
...
#  cod_rec.expectedCOD = expected_cod;
  ...
  xyplot(cod_rec.targetCOD,"@-;measured COD;"\
    ...
    , setCODOriginAt(cod_step1.targetCOD,cod_rec.lattice, "BPM7"), "-@;COD after correction;");xlabel("position [m]");ylabel("COD [mm]");grid on;
