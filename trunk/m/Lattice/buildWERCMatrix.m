...
function all_elements = buildWERCMatrix(varargin)
  ...
  DT(0.175, "BMD1IN", bmDuct),
  BM(bmprop, "BM1", bmDuct),
  DT(0.175, "BMD1OUT", bmDuct),
  ...
  DT(0.175, "BMD2IN", bmDuct),
  BM(bmprop, "BM2", bmDuct),
  DT(0.175, "BMD2OUT", bmDuct),
  DT(0.35, "MRD5", MRD5),
  ...
  DT(0.175, "BMD3IN", bmDuct),
  BM(bmprop, "BM3", bmDuct),
  DT(0.175, "BMD3OUT", bmDuct),
  ...
  DT(0.175, "BMD4IN", bmDuct),
  BM(bmprop, "BM4", bmDuct),
  DT(0.175, "BMD4OUT", bmDuct),
  ...
  DT(0.175, "BMD5IN", bmDuct),
  BM(bmprop, "BM5", bmDuct),
  DT(0.175,"BMD5OUT", bmDuct),
  ...
  DT(0.175,"BMD6IN", bmDuct),
  BM(bmprop, "BM6", bmDuct),
  DT(0.175, "BMD6OUT", bmDuct),
  ...
  DT(0.175,"BMD7IN",bmDuct),
  BM(bmprop, "BM7", bmDuct),
  DT(0.175,"BMD7OUT", bmDuct),
  ...
  DT(0.175,"BMD8IN", bmDuct),
  BM(bmprop, "BM8", bmDuct),
  DT(0.175,"BMD8OUT", bmDuct),
