...
function [particlesAtESD, lastParicle, initialParticles] =\
  separatrixTracking(sxRecord, nParticles, nLoop)
  
  sx1 = sextupoleSetting(sxRecord.brho, sxRecord.isx1, "SX1");
  sx2 = sextupoleSetting(sxRecord.brho, sxRecord.isx2, "SX2");
  sx3 = sextupoleSetting(sxRecord.brho, sxRecord.isx3, "SX3");
  ...
  initialParticles = makeParticles(sxRecord.lattice{end}\
    , sxRecord.em.x, sxRecord.em.y, nParticles);
