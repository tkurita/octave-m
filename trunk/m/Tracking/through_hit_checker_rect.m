## -*- texinfo -*-
## @deftypefn {Function File} {@var{result} =} through_hit_checker_rect(@var{arg})
##
## @end deftypefn

##== History
## 2008-04-17
## * rename to through_hit_checker_rect
## 
## 2008-03-27
## * append flags field
## 
...
function particles = through_hit_checker_rect(an_elem, particles)
